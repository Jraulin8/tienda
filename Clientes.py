...
class Clientes:
    def __init__(self, ventana):
        ...
        self.cbxGenero["values"] =  "Masculino", "Femenino"	
...
#funcion para  desbloquear para guardar datos
    ...
    def desbloquear_guardar (self):
        ...
        self.btnNuevo.confi(state="disabled")
    ...
    def guardar(self):
        if self.txtCedula.get()!="" and self.txtNombres.get()!=""and self.txtApellidos.get()!="" and self.txtDireccion.get()!=""and self.txtTelefono.get()!="" and self.txtCorreo.get()!="":
           ...
           if Conexion.run_query(self.sql,self.parametros):
               messagebox.showinfo(message="Los Datos del Cliente guardados con  exito",title="cliente")
               Clientes.limpiar(self)
           else:
               messagebox.showerror(message="los datos del cliente no se pueden guardar")
        else:
